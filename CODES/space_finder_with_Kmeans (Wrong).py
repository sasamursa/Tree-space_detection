...
while(1):
    ...
    bgrMean = bgr.mean()
    rgb_filtered = cv.inRange(bgr, bgrMean-5, 255)
    ...
    whiteMask = cv.inRange(masked_image,lower_white, upper_white)
    
    
    greenMask = cv.inRange(masked_image, lowerRange, upperRange)
